...
public interface RestLiAttachmentReaderCallback
{
  ...
  /**
   * Invoked as a result of calling {@link com.linkedin.restli.common.attachments.RestLiAttachmentReader#abandonAllAttachments()}.
   * This will be invoked at some time in the future when all the attachments in this reader have been abandoned.
   */
