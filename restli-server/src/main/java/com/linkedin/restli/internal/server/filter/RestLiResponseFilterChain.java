...
public final class RestLiResponseFilterChain implements NextResponseFilter
{
  ...
  private final RestLiStreamingAttachments _restLiStreamingAttachments;
  private int _cursor;
                                   ...
                                   final RestLiStreamingAttachments streamingAttachments)
  {
    ...
    _restLiStreamingAttachments = streamingAttachments;
  }
  ...
  public void onResponse(final FilterRequestContext requestContext, final FilterResponseContext responseContext)
  {
    ...
    else
    {
      ...
      _restLiResponseFilterChainCallback.onCompletion(responseContext.getResponseData(), _restLiStreamingAttachments);
    }
  }
}
