...
public class MultiPartMIMEReader {
    ...
    private class R2MultiPartMimeReader implements Reader {
        ...
        //todo - we could probably syncrhonize a bit more then we are now. This wouldn't hurt perf because we only a single thread should ever call these at the same time
    ...
    public class SinglePartMIMEReader {
        ...
        //result in StreamBusyException
        public void abandonPart() throws PartFinishedException, StreamBusyException, StreamFinishedException {
