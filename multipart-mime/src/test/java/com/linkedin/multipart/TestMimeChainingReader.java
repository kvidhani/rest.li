...
public class TestMIMEChainingReader extends AbstractMIMEUnitTest {
    ...
    public void testMimeReaderDataSource(final int chunkSize) throws Exception {
        ...
        ClientMultiPartMIMEReaderReceiver _clientReceiver =
                new ClientMultiPartMIMEReaderReceiver(latch);
        ...
        ServerMultiPartMIMEChainReaderWriter _serverSender =
                new ServerMultiPartMIMEChainReaderWriter(callback, reader);
    ...
    private static class ServerMultiPartMIMEChainReaderWriter implements MultiPartMIMEReaderCallback {
        ...
        ServerMultiPartMIMEChainReaderWriter(final Callback<StreamResponse> callback,
